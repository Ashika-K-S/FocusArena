...
function RoomLobby() {
  ...
  const fetchRoom = async () => {
    ...
    try {
      ...
      setError(
        "Failed to locate this arena. It may have been decommissioned."
      );
    }
  };
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const diff =
        10 - Math.floor((now - started) / 1000);
    ...
    return (
      ...
      >
        ...
        <div className="loader">
          Synchronizing with Arena {roomCode}...
        </div>
