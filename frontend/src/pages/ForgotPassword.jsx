    ...
    <div className="flex-center" style={{ minHeight: '90vh' }}>
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontSize: '2rem', marginBottom: '0.5rem' }} className="text-gradient">Security Protocol</h2>
              ...
              <div className="form-group">
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input
                    ...
                    style={{ paddingLeft: '2.75rem', letterSpacing: '0.25em', fontWeight: '700', textAlign: 'center' }}
                    value={otp}
          ...
          {step === 3 && (
            ...
            >
              ...
              <button 
                ...
                disabled={loading}
              >
                {loading ? "Resetting..." : "Update Password"} <CheckCircle2 size={18} />
              </button>
            </motion.form>
          )}
        </AnimatePresence>
