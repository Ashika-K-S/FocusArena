    ...
    >
      ...
      <div className="glass-card">
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <h1 className="text-gradient" style={{ fontSize: '2.25rem', marginBottom: '0.5rem' }}>Join Battle</h1>
          <p style={{ color: 'var(--text-muted)' }}>Enter the secret code to join an active arena</p>
        </div>
